...
txtDisplay= Entry(cal,font=("arial", 20, 'bold'), textvariable=text_Input, bd=30, insertwidth=4,bg="cyan", justify='right').grid(columnspan=4)
btn7=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="7",bg="cyan",command=lambda:btnClick(7)).grid(row=1,column=0)

btn8=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="8", bg="cyan",command=lambda:btnClick(8)).grid(row=1,column=1)

btn9=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="9", bg="cyan",command=lambda:btnClick(9)).grid(row=1,column=2)

Addition=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="+", bg="cyan",command=lambda:btnClick("+")).grid(row=1,column=3)
#xxxxxxxxxxxSECOND ROWxxxxxxxxxxxx
...
#xxxxxxxxxxxTHIRD ROWxxxxxxxxxxxxxx
btn1=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="1", bg="cyan",command=lambda:btnClick(1)).grid(row=3,column=0)

btn2=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="2", bg="cyan",command=lambda:btnClick(2)).grid(row=3,column=1)

btn3=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="3", bg="cyan",command=lambda:btnClick(3)).grid(row=3,column=2)
...
#xxxxxxxxxxxFORTH ROWxxxxxxxxxxxxxx
btn0=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="0", bg="cyan",command=lambda:btnClick(0)).grid(row=4,column=1)

btnClear=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="C", bg="cyan",command=btnClearDisplay).grid(row=4,column=0)

btnEquals=Button(cal,padx=16,pady=16,bd=8,fg="Black", font=("arial", 20, 'bold'),
            text="=", bg="cyan",command=btnEqualsInput).grid(row=4,column=2)
